    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # 좌표를 이미지에 그리기
                cv2.circle(image, (cx_index, cy_index), 10, (0, 255, 0), -1)
                ...
                # 좌표를 이미지에 그리기
                cv2.circle(image, (cx_thumb, cy_thumb), 10, (0, 255, 0), -1)
        ...
        # 엄지와 검지의 거리를 표시
        cv2.putText(image, f'Dist.: {int(dist_px_of_fingertips)}', (5, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 2)
